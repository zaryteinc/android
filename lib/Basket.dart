    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 58.0, middle: 0.502),
                  Pin(size: 22.0, end: 25.0),
                  child: Text(
                    'Total:',
                    style: TextStyle(
                      fontFamily: 'Dungeon',
                ...
                Pinned.fromPins(
                  Pin(size: 90.0, start: 24.0),
                  Pin(size: 17.0, middle: 0.1954),
                  child: Text(
                    'Skyy Vodka',
                    style: TextStyle(
                      fontFamily: 'Courier New',
                ...
                Pinned.fromPins(
                  Pin(size: 72.0, start: 24.0),
                  Pin(size: 17.0, middle: 0.3172),
                  child: Text(
                    'Morretti',
                    style: TextStyle(
                      fontFamily: 'Courier New',
          ...
          Pinned.fromPins(
            Pin(size: 45.0, middle: 0.7931),
            Pin(size: 17.0, middle: 0.4089),
            child: Text(
              '£8.00',
              style: TextStyle(
                fontFamily: 'Courier New',
          ...
          Pinned.fromPins(
            Pin(start: 45.5, end: 44.5),
            Pin(size: 427.0, middle: 0.6521),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 1.0, middle: 0.6623),
                  Pin(start: 0.0, end: 0.0),
...
const String _svg_xanef =
    '<svg viewBox="245.5 276.5 1.0 427.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(245.5, 276.5)" d="M 0 427 L 0 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
const String _svg_pu959u =
    '<svg viewBox="45.5 324.5 303.0 1.0" ><path transform="translate(45.5, 324.5)" d="M 0 0 L 303 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_sizrf2 =
    '<svg viewBox="45.5 373.5 303.0 1.0" ><path transform="translate(45.5, 373.5)" d="M 0 0 L 303 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_voaitq =
    '<svg viewBox="45.5 419.5 303.0 1.0" ><path transform="translate(45.5, 419.5)" d="M 0 0 L 303 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_fvorun =
    '<svg viewBox="45.5 626.5 303.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(45.5, 626.5)" d="M 0 0 L 303 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';

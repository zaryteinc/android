...
class addmixer extends StatelessWidget {
  addmixer({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'Backghround' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 110.0, middle: 0.2132),
            child:
                // Adobe XD layer: '1st box' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: 'Smirnoff vodka pretty basic really',
                          style: TextStyle(
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: 'Skyy vodka infused with passionfruit.',
                          style: TextStyle(
                            fontFamily: 'Courier New',
                            fontSize: 10,
                          ),
          ...
          Pinned.fromPins(
            Pin(size: 281.0, end: 24.0),
            Pin(size: 464.0, middle: 0.6357),
            child:
                // Adobe XD layer: 'Prices' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(size: 49.0, start: 2.0),
                  Pin(size: 17.0, middle: 0.6667),
                  child: Text(
                    '£4.00',
                    style: TextStyle(
                      fontFamily: 'Dungeon',
          ...
          Pinned.fromPins(
            Pin(start: 23.0, end: 18.0),
            Pin(start: 99.0, end: 42.0),
            child:
                // Adobe XD layer: 'add mixedr' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 94.0, middle: 0.4767),
                  Pin(size: 17.0, start: 27.0),
                  child: Text(
                    'Add a Mixer',
                    style: TextStyle(
                      fontFamily: 'Dungeon',
                ...
                Pinned.fromPins(
                  Pin(size: 24.0, start: 13.2),
                  Pin(size: 24.0, start: 23.0),
                  child:
                      // Adobe XD layer: 'MDI / arrow-left-ci…' (group)
                      Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
                      ...
                      Pinned.fromPins(
                        ...
                        Pin(start: 2.0, end: 2.0),
                        child:
                            // Adobe XD layer: 'Path / arrow-left-c…' (shape)
                            SvgPicture.string(
                          _svg_tpdya0,
                          allowDrawingOutsideViewBox: true,
                          fit: BoxFit.fill,
                ...
                Pinned.fromPins(
                  Pin(start: 29.0, end: 32.0),
                  Pin(size: 39.0, middle: 0.4024),
                  child: ClipRect(
                    child: BackdropFilter(
                      filter: ui.ImageFilter.blur(sigmaX: 30.0, sigmaY: 30.0),
                      child: Container(
                ...
                Pinned.fromPins(
                  Pin(size: 216.0, middle: 0.5074),
                  Pin(size: 22.0, start: 62.0),
                  child: Text(
                    '*Prices include a mixer, some mixers\n available for an extra cost',
                    style: TextStyle(
                      fontFamily: 'Courier New',
                      fontSize: 10,
                      color: const Color(0xffffffff),
                ...
                Pinned.fromPins(
                  Pin(size: 162.0, start: 45.0),
                  Pin(size: 34.0, middle: 0.605),
                  child: Text(
                    'Lemonade \n+ Blckcrnt cordial',
                    style: TextStyle(
                      fontFamily: 'Courier New',
                ...
                Pinned.fromPins(
                  Pin(size: 153.0, start: 45.0),
                  Pin(size: 34.0, middle: 0.8092),
                  child: Text(
                    'Soda \n+ Blckrnt cordial',
                    style: TextStyle(
                      fontFamily: 'Courier New',
...
const String _svg_tpdya0 =
    '<svg viewBox="2.0 2.0 20.0 20.0" ><path  d="M 2 12 C 2 6.477152347564697 6.477153778076172 1.999999046325684 12.00000190734863 2 C 17.52284622192383 2 22 6.477152347564697 22 11.99999904632568 C 22 17.52285003662109 17.52284622192383 22.00000381469727 11.99999713897705 22.00000190734863 C 6.477152347564697 22.00000381469727 1.999999046325684 17.52285003662109 2 12.00000095367432 M 18 11 L 10 11 L 13.5 7.5 L 12.07999992370605 6.079999923706055 L 6.159999847412109 12 L 12.07999992370605 17.92000007629395 L 13.5 16.5 L 10 13 L 18 13 L 18 11 Z" fill="#ffffff" fill-opacity="0.6" stroke="none" stroke-width="1" stroke-opacity="0.6" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';

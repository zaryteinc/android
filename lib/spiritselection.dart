...
class spiritselection extends StatelessWidget {
  spiritselection({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 24.0, end: 22.0),
            Pin(size: 181.0, start: 112.0),
            child:
                // Adobe XD layer: 'Offers' (group)
                Stack(
              children: <Widget>[

    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 23.0, end: -159.0),
            Pin(size: 164.0, middle: 0.23),
            child:
                // Adobe XD layer: '1st box' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 347.0, start: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 312.0, start: 6.0),
                  Pin(size: 77.0, start: 11.0),
                  child: Text.rich(
                    TextSpan(
                      style: TextStyle(
                        fontFamily: 'Dungeon',
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              'The porn star martini is a passion-fruit-flavoured\ncocktail made with vanilla-flavoured vodka, Passoã, \npassion fruit juice, and lime',
                          style: TextStyle(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 171.0, middle: 0.3618),
            child:
                // Adobe XD layer: '2nd box' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(start: 7.0, end: 16.0),
                  Pin(size: 33.0, middle: 0.7246),
                  child:
                      // Adobe XD layer: 'esp' (text)
                      Text.rich(
                    TextSpan(
                      style: TextStyle(
                        fontFamily: 'Dungeon',
                      ...
                      children: [
                        TextSpan(
                          text:
                              'The espresso martini is a cold, coffee-flavored \ncocktail made with vodka, espresso coffee, and coffee \nliqueur.',
                          style: TextStyle(
                            fontFamily: 'Courier New',
                            fontSize: 10,
                          ),
                ...
                Pinned.fromPins(
                  Pin(size: 105.0, start: 6.0),
                  Pin(size: 41.0, middle: 0.5308),
                  child:
                      // Adobe XD layer: 'Espresso Martini' (text)
                      Text(
                    'Espresso Martini\n',
                    style: TextStyle(
                      fontFamily: 'Haettenschweiler',
          ...
          Pinned.fromPins(
            ...
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(start: 6.0, end: 11.0),
                  Pin(size: 44.0, middle: 0.5758),
                  child: Text.rich(
                    TextSpan(
                      style: TextStyle(
                        fontFamily: 'Dungeon',
                      ...
                      children: [
                        TextSpan(
                          text:
                              'The martini is a cocktail made with gin and vermouth, \nand garnished with an olive or a lemon twist. Over the \nyears, the martini has become one of the best-known \nmixed alcoholic beverages.',
                          style: TextStyle(
                            fontFamily: 'Courier New',
                            fontSize: 10,
                          ),
          ...
          Pinned.fromPins(
            Pin(start: 23.0, end: 23.0),
            Pin(size: 466.0, end: -13.0),
            child:
                // Adobe XD layer: '5th box' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(start: 29.0, end: -268.3),
            Pin(size: 300.0, start: 115.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 186.0, end: 24.0),
            Pin(size: 25.0, start: 115.0),
            child:
                // Adobe XD layer: 'Random cocktail' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 136.0, start: 10.0),
                  Pin(size: 17.0, start: 3.0),
                  child:
                      // Adobe XD layer: 'Random cocktail' (text)
                      Text(
                    'Random Cocktail',
                    style: TextStyle(
                      fontFamily: 'Dungeon',
                ...
                Pinned.fromPins(
                  Pin(size: 18.0, end: 12.4),
                  Pin(start: 4.0, end: 3.0),
                  child:
                      // Adobe XD layer: 'Path / glass-cockta…' (shape)
                      SvgPicture.string(
                    _svg_yci1x0,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
...
const String _svg_se =
    '<svg viewBox="639.3 486.4 22.0 19.0" ><path transform="translate(638.25, 484.37)" d="M 11 11 L 16.76000022888184 3.619999885559082 C 17.09806251525879 3.186013460159302 17.02210235595703 2.560466289520264 16.59000015258789 2.220000267028809 C 16.42215538024902 2.08504581451416 16.2152271270752 2.007885932922363 16 2 L 2 2 C 1.774435758590698 2.001308441162109 1.555939316749573 2.078839540481567 1.379999995231628 2.220000028610229 C 0.9478969573974609 2.560465812683105 0.8719372749328613 3.186013221740723 1.209999799728394 3.619999647140503 L 7 11 L 7 16.8700008392334 C 6.963335514068604 17.17660331726074 7.070371627807617 17.48294639587402 7.289999961853027 17.70000076293945 L 9.289999961853027 19.70000076293945 C 9.680037498474121 20.08772468566895 10.30996227264404 20.08772468566895 10.69999980926514 19.70000076293945 C 10.92328071594238 19.48481369018555 11.03409957885742 19.1782169342041 11 18.8700008392334 L 11 11 M 13 16 L 18 21 L 23 16 L 13 16 Z" fill="#ffffff" stroke="#000000" stroke-width="2" stroke-opacity="0.0" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_yci1x0 =
    '<svg viewBox="184.3 209.4 18.0 18.0" ><path transform="translate(181.25, 206.37)" d="M 7.5 7 L 5.5 5 L 18.5 5 L 16.5 7 M 11 13 L 11 19 L 6 19 L 6 21 L 18 21 L 18 19 L 13 19 L 13 13 L 21 5 L 21 3 L 3 3 L 3 5 L 11 13 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
